...
class CountryController {
    constructor() {
        ...
        this.findAll = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            return data.length > 1 ? (0, response_1.default)({ res: res, message: messages_1.default.COUNTRY.COUNTRY_FOUND, data: data }) : next(error_handler_1.default.notFound(messages_1.default.COUNTRY.COUNTRY_NOT_FOUND));
        });
