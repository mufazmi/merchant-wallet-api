...
class MerchantWalletTransactionModel extends sequelize_1.Model {
}
...
MerchantWalletTransactionModel.hasMany(merchant_funds_1.default, { sourceKey: 'id', foreignKey: 'transaction_id', as: 'merchant_funds' });
exports.default = MerchantWalletTransactionModel;
